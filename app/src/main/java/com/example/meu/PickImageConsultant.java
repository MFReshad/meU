...
public class PickImageConsultant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pick_image_consultant);
 ...
 */
    ...
    private void intent() {
        Intent myIntent1 = new Intent(PickImageConsultant.this, ConsultantChatView.class);

        PickImageConsultant.this.startActivity(myIntent1);
        finish();
    }
}